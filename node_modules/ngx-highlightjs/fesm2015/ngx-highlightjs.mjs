...
function getPolicy() {
    ...
    if (!policy) {
        try {
            policy = (_a = window === null || window === void 0 ? void 0 : window.trustedTypes) === null || _a === void 0 ? void 0 : _a.createPolicy('ngx-highlightjs', {
                createHTML: (s) => s,
            });
        }
        catch (_b) {
...
class Highlight {
    ...
    ngOnChanges(changes) {
        var _a;
        if (isPlatformBrowser(this.platformId) &&
            ((_a = changes === null || changes === void 0 ? void 0 : changes.code) === null || _a === void 0 ? void 0 : _a.currentValue) !== null &&
